...
// Used on Cesium entities' properties field.
export const PROPERTY_MARKER_IDENTIFIER = 'isPropertyMarker';
export const CATCHMENT_AREA_IDENTIFIER = 'isCatchmentArea';
